...
if __name__ == "__main__":
    asyncio.run(setup_and_run(
        query='''
        'background': '밀레니얼 세대가 브랜드의 사회적 책임에 민감하지만, 기존 기업의 ESG 활동이 딱딱하게 느껴짐'
        'solution': '환경 보호 메시지를 유쾌하고 일상적인 방식으로 전달'
        'target': '20~30대 직장인, SNS 활동이 활발한 소비자'
        'content': '작은 행동이 지구를 지킨다는 공감 메시지 전달, 구체적인 실천 방법 제시'
        'assistance': '지구를위한작은습관, 일상속ESG, 재미있는친환경'
        ''',
